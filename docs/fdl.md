...
| `ephemeral_storage_limit` </br> *string*                          | Limit size for ephemeral storage following the [kubernetes format](https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/#meaning-of-ephemeral-storage). Optional (default: "")                 |
