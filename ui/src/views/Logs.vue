    ...
    <div class="mb-1">		
        ...
        >
            ...
            <tr >
                ...
                <td class="text-xs-center" v-show="props.item.status!='Pending'">{{ moment(props.item.start).format("YYYY-MM-DD HH:mm:ss") }}</td>
                <td class="text-xs-center" v-show="props.item.status!='Pending'">{{ moment(props.item.finish).format("YYYY-MM-DD HH:mm:ss") }}</td>
